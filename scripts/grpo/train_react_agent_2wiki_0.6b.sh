...
export CUDA_VISIBLE_DEVICES=6  # Set this variable as needed
...
accelerate launch --config_file "$REPO_ROOT/configs/accelerate_configs/deepspeed_zero3.yaml" --num_processes 1 --main_process_port 0 \
    ...
    --enable_stateful \
    --dataset_name 2wikimultihopqa_filtered \
    ...
    --output_dir "$REPO_ROOT/result/qwen3-embedding-0.6b_react-agent_2wiki" \
    --num_generations 8 \
    --num_iterations 1 \
    --learning_rate 1e-5 \
